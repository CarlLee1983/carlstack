...
updatedDate: 2026-09-26T09:30:05+08:00
draft: false
featured: false
tags:
...
**架構的選擇不應由服務數量決定，而應由邊界要解決的問題決定。** 若你的問題是 AI 變更太大、設計審查跟不上，可以接著讀[《AI 寫碼變快，微服務能隔離故障，不能替你審查程式》](/blog/ai-era-microservices-change-containment/)；它把合併前的變更品質和上線後的故障隔離拆成兩項獨立決策。
