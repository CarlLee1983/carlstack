...
[ Client ]                                                    [ Amazon S3 ]
    │                                                               │
    │ ─── 1. POST /bucket/large.iso?uploads (Initiate) ───────────► │
    │ ◄── 回傳 UploadId ("VXBsb2FkSW...") ───────────────────────── │
    │                                                               │
    │ ─── 2a. PUT /bucket/large.iso?partNumber=1&uploadId=... ────► │
    │ ◄── 回傳 200 OK + ETag: "a1b2c3d4..." ─────────────────────── │
    │ ─── 2b. PUT /bucket/large.iso?partNumber=2&uploadId=... ────► │
    │ ◄── 回傳 200 OK + ETag: "e5f6g7h8..." ─────────────────────── │
    │                                                               │
    │ ─── 3. POST /bucket/large.iso?uploadId=... (Complete) ──────► │
    │        <CompleteMultipartUpload>                              │
    │          <Part><PartNumber>1</PartNumber><ETag>...</ETag></Part>│
    │          <Part><PartNumber>2</PartNumber><ETag>...</ETag></Part>│
    │        </CompleteMultipartUpload>                             │
    │ ◄── 200 OK (最終 Object 上線，回傳複合 ETag: "...-2") ───────── │
```
...
```text
ETag = Hex( MD5( Binary(MD5_Part1) + Binary(MD5_Part2) + ... + Binary(MD5_PartN) ) ) + "-" + N
```
