...
name = "gaming-docs"
description = "平台文件庫"
workspace = "~/Dev/Docs/GamingPlatform"
runtime = "codex"
policy = "read-only"
...
1. **實體目錄與身分鎖定**：`stationhub` 這個 Agent 永遠只能在 `~/Dev/CMG/StationHub` 執行。遠端呼叫者無論如何構造 Prompt，其子程序的工作目錄均被固定在該 realpath。
