...
import HierarchicalTimingWheelKernelDiagram from "../../components/HierarchicalTimingWheelKernelDiagram.astro";
import DistributedSchedulerClusterDiagram from "../../components/DistributedSchedulerClusterDiagram.astro";
...
<HierarchicalTimingWheelKernelDiagram />
...
生產級分散式調度系統必須透過**調度協調中心（Coordinators）**與**執行工作節點（Workers）**的職責分離來建構：

<DistributedSchedulerClusterDiagram />
