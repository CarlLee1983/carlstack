...
[@polydao（Mr. Buzzoni）提出了一種結合 Claude Code 與 Obsidian 的解法](https://x.com/polydao/status/2094307289280716815)：**「Loop Engineering」**。原文把 Vault 視為迴圈的狀態，而非聊天視窗；其具體順序是 capture、context、在 Git Worktree 草擬、由 Critic 檢查 diff，最後只以 append 的方式 commit 回 Vault。
